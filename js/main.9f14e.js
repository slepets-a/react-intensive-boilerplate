...
const withProfile = Enhanced => class WithConsumer extends _react.Component {
  render() {
    return _react.default.createElement(Consumer, null, context => _react.default.createElement(Enhanced, _extends({}, context, this.props)));
  }
...
var _stylesM = _interopRequireDefault(__webpack_require__(50));
...
class Catcher extends _react.Component {
  ...
  render() {
    ...
    if (error) {
      ...
      }, _react.default.createElement("span", null, "A mysterious \uD83D\uDC7D \xA0error \uD83D\uDCDB \xA0occured."), _react.default.createElement("p", null, "Our space \uD83D\uDEF0 \xA0engineers strike team \uD83D\uDC69\uD83C\uDFFC\u200D\uD83D\uDE80 \uD83D\uDC68\uD83C\uDFFC\u200D\uD83D\uDE80 \xA0is already working \uD83D\uDE80 \xA0in order to fix that for you!"));
    }
...
var _socket = _interopRequireDefault(__webpack_require__(87));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Core
const socket = (0, _socket.default)('https://lab.lectrum.io', {
  path: '/react/ws'
});
...
module.exports = {"postman":"styles-m__postman---1QHz-"};
...
// Core
// Instruments
const Postman = () => _react.default.createElement(_withProfile.Consumer, null, context => _react.default.createElement("section", {
  className: _stylesM.default.postman
}, _react.default.createElement("img", {
  src: context.avatar
}), _react.default.createElement("span", null, "Welcome online, ", context.currentUserFirstName, "!")));
...
// extracted by mini-css-extract-plugin
module.exports = {"counter":"styles-m__counter---3p38b"};
...
var _stylesM = _interopRequireDefault(__webpack_require__(47));
...
const Counter = ({
  ...
  className: _stylesM.default.counter
}, "Posts count: ", count);
...
// extracted by mini-css-extract-plugin
module.exports = {"icon":"styles-m__icon---PmWy5","like":"styles-m__like---1o641","liked":"styles-m__liked---2370B"};
...
var _stylesM = _interopRequireDefault(__webpack_require__(52));
...
let Like = (0, _withProfile.withProfile)(_class = class Like extends _react.Component {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(this, "state", {
      showLikers: false
    }), "_showLikers", () => {
      this.setState(() => ({
        showLikers: true
      ...
      return likedByMe ? `${_stylesM.default.icon} ${_stylesM.default.liked}` : `${_stylesM.default.icon}`;
    }), "_getLikersList", () => {
      const {
        showLikers
      } = this.state;
  ...
  render() {
    ...
    }, "Like"), _react.default.createElement("div", null, likers, _react.default.createElement("span", {
...
_defineProperty(_defineProperty(Like, "propTypes", {
...
// extracted by mini-css-extract-plugin
module.exports = {"cross":"styles-m__cross---14-kS","post":"styles-m__post---14CVE"};
...
var _stylesM = _interopRequireDefault(__webpack_require__(55));

var _Like = _interopRequireDefault(__webpack_require__(53));
...
class Post extends _react.Component {
  constructor(...args) {
    ...
    return _temp = super(...args), _defineProperty(_defineProperty(this, "_removePost", () => {
      const {
        _removePost,
        id
      } = this.props;
      ...
      return `${firstName} ${lastName}` === `${context.currentUserFirstName} ${context.currentUserLastName}` ? _react.default.createElement("span", {
  ...
  render() {
    ...
    }, this._getCross(context), _react.default.createElement("img", {
      src: avatar
    }), _react.default.createElement("a", null, `${firstName} ${lastName}`), _react.default.createElement("time", null, _moment.default.unix(created).format('MMMM D h:mm:ss a')), _react.default.createElement("p", null, comment), _react.default.createElement(_Like.default, {
      _likePost: _likePost,
      id: id,
      likes: likes
    })));
...
// extracted by mini-css-extract-plugin
module.exports = {"composer":"styles-m__composer---1OAz8"};
...
var _stylesM = _interopRequireDefault(__webpack_require__(59));
...
class Composer extends _react.Component {
  constructor(...args) {
    ...
    return _temp = super(...args), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(this, "state", {
      comment: ''
    }), "_handleSubmit", event => {
      ...
      enterKey ? this._createPost() : null;
...
_defineProperty(Composer, "propTypes", {
  _createPost: _propTypes.func.isRequired
});

var _default = (0, _withProfile.withProfile)(Composer);
...
// extracted by mini-css-extract-plugin
module.exports = {"offline":"styles-m__offline---5W6QV","online":"styles-m__online---2OCuy","status":"styles-m__status---1XPVw","statusBar":"styles-m__statusBar---39CY3"};
...
var _stylesM = _interopRequireDefault(__webpack_require__(62));
...
let StatusBar = (0, _withProfile.withProfile)(_class = class StatusBar extends _react.Component {
  ...
  componentDidMount() {
    _init.socket.on('connect', () => {
      this.setState(() => ({
        online: true
      }));
    });

    _init.socket.on('disconnect', () => {
      this.setState(() => ({
        online: false
      }));
    });
  ...
  componentWillUnmount() {
    _init.socket.removeListener('connect');

    _init.socket.removeListener('disconnect');
  }
  ...
  render() {
    ...
    const statusStyle = (0, _classnames.default)(_stylesM.default.status, {
      [_stylesM.default.online]: online,
      [_stylesM.default.offline]: !online
    });
    ...
    }, _react.default.createElement("div", null, statusMessage), _react.default.createElement("span", null)), _react.default.createElement("button", null, _react.default.createElement("img", {
      src: avatar
...
exports.getFullApiUrl = exports.getUniqueID = exports.sum = void 0;
...
exports.url = exports.api = exports.TOKEN = exports.GROUP_ID = void 0;

var _instruments = __webpack_require__(88);
...
exports.url = url;
const api = (0, _instruments.getFullApiUrl)(url, GROUP_ID);
exports.api = api;
...
// extracted by mini-css-extract-plugin
module.exports = {"feed":"styles-m__feed---rnD6c","postInEnd":"styles-m__postInEnd---2_Vd_","postInStart":"styles-m__postInStart---1tBuJ","postOutEnd":"styles-m__postOutEnd---2sGMJ","postOutStart":"styles-m__postOutStart---23qTP"};
...
var _TransitionGroup = __webpack_require__(35);
...
var _Transition = __webpack_require__(37);
...
var _CSSTransition = __webpack_require__(100);

var _CSSTransition2 = _interopRequireDefault(_CSSTransition);

var _ReplaceTransition = __webpack_require__(94);
...
var _gsap = _interopRequireDefault(__webpack_require__(92));
...
var _StatusBar = _interopRequireDefault(__webpack_require__(64));

var _Composer = _interopRequireDefault(__webpack_require__(60));

var _Post = _interopRequireDefault(__webpack_require__(57));

var _Catcher = _interopRequireDefault(__webpack_require__(19));

var _Counter = _interopRequireDefault(__webpack_require__(48));

var _Spinner = _interopRequireDefault(__webpack_require__(45));

var _Postman = _interopRequireDefault(__webpack_require__(42));
...
let Feed = (0, _withProfile.withProfile)(_class = class Feed extends _react.Component {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(this, "state", {
      posts: [],
      ...
      _gsap.default.fromTo(composer, 1, {
        opacity: 0
      }, {
        opacity: 1
      });
    }), "_handleCounterAppear", counter => {
      _gsap.default.fromTo(counter, 1, {
        opacity: 0
      }, {
        opacity: 1
      });
    }), "_handlePostmanAppear", postman => {
      _gsap.default.fromTo(postman, 1, {
        x: 400,
        opacity: 0
      }, {
        x: 0,
  ...
  componentDidMount() {
    ...
    _init.socket.on('remove', postJSON => {
      const {
        data: removedPost,
        meta
      } = JSON.parse(postJSON);
  ...
  render() {
    ...
    const postsJSX = posts.map(({
      ...
      classNames: {
        enter: _stylesM.default.postInStart,
        enterActive: _stylesM.default.postInEnd,
        exit: _stylesM.default.postOutStart,
        exitActive: _stylesM.default.postOutEnd
      },
      key: id,
      timeout: {
        enter: 500,
    ...
    }, _react.default.createElement(_Catcher.default, null, _react.default.createElement(_Post.default, {
    ...
    return _react.default.createElement("section", {
    ...
    }), _react.default.createElement(_StatusBar.default, null), _react.default.createElement(_reactTransitionGroup.Transition, {
      appear: true,
      "in": true,
      timeout: 1000,
      onEnter: this._handleComposerAppear
    }, _react.default.createElement(_Composer.default, {
      ...
      count: posts.length
    })), _react.default.createElement(_reactTransitionGroup.TransitionGroup, null, postsJSX), _react.default.createElement(_reactTransitionGroup.Transition, {
      appear: true,
      "in": true,
      timeout: 3000,
      onEnter: this._handlePostmanAppear,
      onEntered: this._handlePostmanDisappear
    }, _react.default.createElement(_Postman.default, null)));
  }
...
let App = (_dec = (0, _reactHotLoader.hot)(module), _dec(_class = class App extends _react.Component {
  ...
  render() {
    return _react.default.createElement(_Catcher.default, null, _react.default.createElement(_withProfile.Provider, {
      value: this.state
